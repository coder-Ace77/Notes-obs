...
Distributed cache provide us a great way to reduce latency. Be it for some computation which takes lot of computation or may be storing some data for faster access. Be it any case cache is not 100% guaranteed to give us better result due to cache hit/cache miss.
