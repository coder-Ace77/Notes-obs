...
Sometimes to simplyfy the dsu we introduce the type of nodes in dsu. The simplest of these type introduction is dead vs alive concept. In this paradigm some value of some nodes will not be considered and this value or property will be aggregated only for the `alive` nodes. 
